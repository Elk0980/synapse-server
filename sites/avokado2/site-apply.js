/* Копия sites/alvi/site-apply.js от 04.09.2026. Отличия: зоны и API Авокадо.
   АВОКАДО · применение текстов и фонов главной из документа avokado2/site (редактируется в кабинете Synapse).
