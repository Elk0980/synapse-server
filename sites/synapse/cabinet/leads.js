(() => {
  ...
  let ctx;
  let identity, currentView, byId, escapeHTML, crmQuery, csrfOptions, scopeParams, formatMoney;
  let initialized = false;
  const api = {};
  const init = (context) => {
    ctx = context;
    ({ identity, currentView, byId, escapeHTML, crmQuery, csrfOptions, scopeParams, formatMoney } = context);
