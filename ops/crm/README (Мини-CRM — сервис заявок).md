...
Для уведомлений с адреса на `synapsebusiness.ru` используется `provider: "gmail"`,
...
Это подключение обслуживает уведомления о заявках администраторам. Оно не создаёт
кампании и не отправляет письма контактам CRM. Массовые рассылки, управление подписками,
отписками и лимитами отправки требуют отдельного механизма.
