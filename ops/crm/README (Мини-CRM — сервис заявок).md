...
Владелец открывает «Настройки → Почта для заявок», выбирает Яндекс Почту или Mail,
...
- После сохранения конфигурация кабинета целиком заменяет SMTP-настройки и двух получателей.
  SMTP endpoints ограничены smtp.yandex.ru:465 и smtp.mail.ru:465, соединение с TLS.
